                ...
                <div class="col">
                    <div class="card mb-grid">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div id="icerik" class="card-header-title">Şoför Seç</div>
                        </div>
                        ...
                        <form action="<?= site_url('defined') ?>" method="post">
                        <div class="form-group">
                            <label class="form-label">Lütfen Şoförü Seçiniz</label>
                            <select name="select" class="form-control js-choice">
                                <?php for ($i = 0;$i<count($drivers);$i++): ?>
                                <option value="<?= $drivers[$i]['id'] ?>"><?= $drivers[$i]['name_surname'] ?></option>
                                <?php endfor; ?>
                            </select>
                            ...
                            <button class="btn btn-pill btn-lg btn-primary">KAYDET</button>
                            </div>
                        </form>
                    </div>
                </div>
